...
| **Recurrent Training** | June 2024 | June 2025 | Current |
| **Emergency Procedures** | June 2024 | June 2025 | Current |
| **CRM Training** | March 2024 | March 2026 | Current |

### Aviation Insurance Context
**Coverage Considerations**:
- GlobalWing provides crew life insurance (amount unknown to applicant)
- Company disability insurance (details needed)
- Workers' compensation coverage for on-duty injuries
- International medical evacuation benefits

---

## SECTION VIII: SIGNATURES AND ACKNOWLEDGMENTS

### Applicant Acknowledgment
I certify that the statements made in this application are true and complete to the best of my knowledge and belief. I understand that any false statement may void this application or any policy issued in reliance thereon.

**Applicant Signature**: Elizabeth A. Darcy  
**Date**: November 15, 2024

### Agent Certification
I certify that I have reviewed this application with the applicant and that all questions have been answered to the best of the applicant's knowledge.

**Agent Signature**: Marcus Thompson, CLU, ChFC  
**Agent License**: CO-LIC-78451  
...
## SECTION IX: FOR COMPANY USE ONLY

**Application Received**: November 15, 2024 11:47 AM MST  
**Received By**: Electronic Submission System  
**Initial Processing**: Assigned to Denver Regional Office  

**Next Steps**: Medical exam scheduling and financial documentation review  
